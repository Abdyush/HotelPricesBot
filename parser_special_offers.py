...
with webdriver.Chrome() as browser:
    ...
    for i in range(len(cards)):
        ...
        if title.text == 'Подарочные сертификаты' or title.text == 'Беззаботное лето с курортом «Мрия»':
        ...
        data_collection.append({
                ...
                "Суммируется с программой лояльности": summ_offers,
